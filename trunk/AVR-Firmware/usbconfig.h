...
#else
#error "No correct AVR cpu type."
#endif

/* --------------------------- Functional Range ---------------------------- */

#define	USB_CFG_MAX_BUS_POWER		200	// mA (Inclusiv Si570)
