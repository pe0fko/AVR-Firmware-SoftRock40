...
The frequency is formatted in MHz as a 8.24 bits value for the Si570.
The Si549 is using the [9.23] value of 152.6MHz

Default:    114.285 MHz (Si570)
			152.6   MHz	(Si549)
